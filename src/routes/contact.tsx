    ...
    <div className="pt-32 pb-24">
      <section className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <Reveal>
          ...
          <h1 className="mt-4 font-display text-5xl md:text-6xl text-charcoal">
            Reserve a private consultation.
          </h1>

          <p className="mt-6 max-w-2xl text-charcoal/70">
            Reach out by phone, WhatsApp or the form below. We respond within one business day.
          </p>
        </Reveal>
        ...
        <div className="mt-16 grid lg:grid-cols-12 gap-10">
          ...
          <Reveal className="lg:col-span-5">
            <div className="rounded-[2rem] bg-charcoal text-ivory p-10 relative overflow-hidden">

              <div className="absolute -top-20 -right-20 h-64 w-64 bg-gold/20 blur-3xl" />
              ...
              <div className="mt-12 rounded-2xl overflow-hidden border border-ivory/10 relative group">
          ...
          <Reveal className="lg:col-span-7" delay={0.1}>
            <form
              ...
              className="rounded-[2rem] border border-border bg-card p-10 shadow-soft"
            >
              ...
              <button
                type="submit"
                className="mt-8 inline-flex items-center gap-3 rounded-full bg-charcoal px-8 py-4 text-xs uppercase tracking-[0.25em] text-ivory hover:bg-gold transition"
              >
...
function Item({ icon: Icon, label, value, href }: any) {
  return (
    <li className="flex items-center gap-4">
      <span className="grid h-11 w-11 place-items-center rounded-full border border-white/10 text-gold">
